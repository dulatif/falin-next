...
const products: Product[] = [
  ...
  },
  {
    ...
    category: "AUDIO",
    image: "https://images.unsplash.com/photo-1618366712010-f4ae9c647dcb?ixlib=rb-4.0.3&auto=format&fit=crop&w=688&q=80",
    price: 348.0,
    rating: 4.7,
    isNew: true,
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1548036328-c9fa89d128fa?ixlib=rb-4.0.3&auto=format&fit=crop&w=1769&q=80",
    price: 199.5,
    rating: 4.3,
  },
  {
      ...
      <CardContent sx={{ flexGrow: 1, display: "flex", flexDirection: "column", gap: 2 }}>
        ...
        <Box sx={{ mt: "auto" }}>
            <Stack direction="row" alignItems="center" justifyContent="space-between">
                ...
                <Button variant="contained" data-shape="icon" size="sm" sx={{ minWidth: "unset", p: 1 }}>
...
export default function SliderProductDemo() {
    ...
    <Stack spacing={2}>
      <Stack direction="row" justifyContent="space-between" alignItems="center">
         <Typography variant="subtitle2" color="text.secondary">
            Multi-slide carousel for product lists.
        </Typography>
        <Stack direction="row" spacing={1}>
            <IconButton onClick={scrollPrev} size="sm" sx={{ border: 1, borderColor: 'divider' }}>
                <CaretLeft />
            </IconButton>
            <IconButton onClick={scrollNext} size="sm" sx={{ border: 1, borderColor: 'divider' }}>
                <CaretRight />
            </IconButton>
        </Stack>
      </Stack>
            ...
            <Box sx={{ display: "flex", gap: 3 }}>
                {products.map((product) => (
                    <Box
                        key={product.id}
                        sx={{
                            flex: { xs: "0 0 85%", sm: "0 0 45%", md: "0 0 30%" },
                            minWidth: 0
                        }}
                    >
